...
| M6 | **Assignment fit** | Wireframe-first and ERD-faithful implementation; reuse FastStarter auth/nav/seed; local verify then deploy. Do **not** score modal/FAB/admin-parity. |
