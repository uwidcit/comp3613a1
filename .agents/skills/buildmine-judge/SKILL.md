...
description: >-
  ...
  evidence quotes. Use in Cursor, GitHub Copilot, or OpenCode when the user
  says buildmine-judge, judge the student, grade from transcript, assess
  competency, or after a guided build session ends.
---

# Buildmine Judge (competency from transcript)
...
1. Collect all `buildmine:sincerity` blocks in order.
