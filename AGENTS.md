...
- This chat is **one phase**. A clarifying question (one missing fact the artefact needs) is not a follow-up. Even at high confidence allow 1 clarifying question and 1 follow-up. Write the artefact, pause, and tell them to open a **new chat** for the next phase.
